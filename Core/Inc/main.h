...
/* Private defines -----------------------------------------------------------*/
#define counter_Pin GPIO_PIN_1
#define counter_GPIO_Port GPIOC
#define counter_EXTI_IRQn EXTI1_IRQn
#define counter_res_Pin GPIO_PIN_3
#define counter_res_GPIO_Port GPIOC
#define counter_res_EXTI_IRQn EXTI3_IRQn
